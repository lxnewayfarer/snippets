...
scp -r root@123.123.123.123:/var/lib/docker/volumes/zendesk-support_redis_data/_data/dump.rdb ./
# Then shut down Redis on the Server_2 and upload dump.rdb to the Server_2
scp -r ./dump.rdb root@123.123.123.123:/var/lib/docker/volumes/zendesk-support_redis_data/_data/dump.rdb
